...
class APiKeysRepository:
    ...
    async def get_by_hashed_api_key(self, api_key: str) -> ApiKeyModel:
    ...
    async def create(self, api_key_create: ApiKeyCreate, hashed_api_key: str, masked_value: str) -> ApiKeyModel:
